...
import com.code.crud.service.ProdutoService;
...
public class ProdutoController {
	...
	public ProdutoVO save(@RequestBody ProdutoVO produtoVO) {
		ProdutoVO produtoVOSaved = produtoService.save(produtoVO);
	...
	public ProdutoVO update(@RequestBody ProdutoVO produtoVO) {
		...
		produtoVOSaved.add(linkTo(methodOn(ProdutoController.class).findById(produtoVO.getId())).withSelfRel());
		return produtoVOSaved;
	}
